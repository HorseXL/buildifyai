                                ...
                                <div className="flex-grow-1">
                                    ...
                                    <div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div className="d-flex my-4">
                                            <Link to="#" className="btn btn-sm btnButtonCancel me-2" id="kt_user_follow_button">
                                            ...
                                            <Link to="#" className="btn btn-sm btnButton me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal">Hire Me</Link>
                                            {/* <!--begin::Menu--> */}
                                            <div className="me-0">
                            ...
                            <div className="card-body border-top p-9">
                                ...
                                <div className="d-flex flex-wrap align-items-center">
                                            ...
                                            <div className="row mb-6">
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="fv-row mb-0">
                                                        ...
                                                        <input type="password" className="form-control form-control-lg form-control-solid" name="confirmemailpassword" id="confirmemailpassword" autoComplete='off'/>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="kt_signin_email_button" className="ms-auto">
                                        <button className="btn btnButtonCancel">Change Email</button>
                                    </div>
                                    {/* <!--end::Action--> */}
                                </div>
                                {/* <!--end::Email Address--> */}
                                ...
                                <div className="d-flex flex-wrap align-items-center mb-10">
                                            ...
                                            <div className="row mb-1">
                                                <div className="col-lg-4">
                                                    <div className="fv-row mb-0">
                                                        ...
                                                        <input type="password" className="form-control form-control-lg form-control-solid" name="currentpassword" id="currentpassword" autoComplete='off'/>
                                                    </div>
                                                </div>
                                                <div className="col-lg-4">
                                                    <div className="fv-row mb-0">
                                                        <label htmlFor="newpassword" className="form-label fs-6 fw-bold mb-3">New Password</label>
                                                        <input type="password" className="form-control form-control-lg form-control-solid" name="newpassword" id="newpassword" autoComplete='off'/>
                                                    </div>
                                                </div>
                                                <div className="col-lg-4">
                                                    <div className="fv-row mb-0">
                                                        <label htmlFor="confirmpassword" className="form-label fs-6 fw-bold mb-3">Confirm New Password</label>
                                                        <input type="password" className="form-control form-control-lg form-control-solid" name="confirmpassword" id="confirmpassword" autoComplete='off'/>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="kt_signin_password_button" className="ms-auto">
                                        <button className="btn btnButtonCancel">Reset Password</button>
                                    </div>
                                    {/* <!--end::Action--> */}
                                </div>
                                {/* <!--end::Password--> */}
                                ...
                                <div className="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                                    ...
                                    <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                        ...
                                        {/* <!--end::Content--> */}
                                        {/* <!--begin::Action--> */}
                                        <Link to="#" className="btn btnButton px-6 align-self-center text-nowrap" data-bs-toggle="modal" data-bs-target="#kt_modal_two_factor_authentication">Enable</Link>
                                        {/* <!--end::Action--> */}
                                    </div>
                                    {/* <!--end::Wrapper--> */}
                                </div>
