...
import a300_25 from '../assets/images/buildifylogo.svg'
                                ...
                                <div className="card-header" id="kt_chat_messenger_header">
                                    ...
                                    <div className="card-title">
                                        ...
                                        <div className="d-flex justify-content-center flex-column me-3">
                                            <Link to="#" className="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Buildify AI</Link>
                                            {/*begin::Info*/}
                                        ...
                                        <div className="d-flex justify-content-start mb-10">
                                            ...
                                            <div className="d-flex flex-column align-items-start">
                                                ...
                                                <div className="d-flex align-items-center mb-2">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-3">
                                                        <Link to="#" className="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Buildify AI</Link>
...
function Buildifyaichat() {
    return <Layout data={<ChatDate />} />
}
export default Buildifyaichat;