      ...
      <div className="d-flex flex-column flex-column-fluid" >
        ...
        <div id="kt_app_content" className="app-content flex-column-fluid">
              ...
              <div className="card card-flush mb-5 mb-xl-10">
                ...
                <div className="card-body d-flex flex-column justify-content-end pe-0">
                  ...
                  <div className="symbol-group symbol-hover flex-nowrap">
                    ...
                    <Link href="#" className="symbol symbol-35px symbol-circle" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">
                  ...
                  <div className="card-toolbar">
                    <ul className="nav">
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4 me-1 active" data-bs-toggle="tab" href="#kt_table_widget_5_tab_1">Ongoing</Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4" data-bs-toggle="tab" href="#kt_table_widget_5_tab_2">Completed</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="text-end text-muted fw-bold">Planning, Plumbing
                                <Link href="#" className="" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">
                              ...
                              <td className="text-end">
                                <Link href="../projectdetails/" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Project Details">
                            ...
                            <tr>
                              <td className="d-flex align-items-center">
                                ...
                                <div className="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                  <div className="symbol-label">
                                    <img src={homeIMG2} className="w-90 img-fluid" />
                                  </div>
                                </div>
                                {/* <!--end::Avatar--> */}
                                {/* <!--begin::User details--> */}
              ...
              <div className="card mb-5 mb-xl-8">
                ...
                <div className="card-header border-0 pt-5">
                  ...
                  <div className="card-toolbar">
                    <ul className="nav">
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4 me-1 active" data-bs-toggle="tab" href="#kt_table_widget_14_tab_1">All</Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4 me-1" data-bs-toggle="tab" href="#kt_table_widget_14_tab_5">Already Bidded</Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4 me-1" data-bs-toggle="tab" href="#kt_table_widget_14_tab_2">Invited</Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4 me-1" data-bs-toggle="tab" href="#kt_table_widget_14_tab_3">Accepted</Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bold px-4" data-bs-toggle="tab" href="#kt_table_widget_14_tab_4">Rejected</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className="tab-content">
                        ...
                        <table className="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="text-end">
                                <Link href="../addbid/" className="btn btn-primary">Bid</Link>
                              </td>
                              <td className="text-end">
                                <Link href="../projectdetails/" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Project Details">
                                  <i className="ki-outline ki-arrow-right fs-2"></i>
                    ...
                    <div className="tab-pane fade" id="kt_table_widget_14_tab_5">
                      ...
                      <div className="card-header border-0 p-0" style={{ minHeight: '0px' }}>
                        <h3 className="card-title align-items-start flex-column">
                          {/* <!-- <Link className="btn btn-primary" href="../addbid/">Bid</Link> --> */}
                        </h3>
                        <div className="card-toolbar">
                        ...
                        <table className="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="text-end">
                                <Link href="../addbid/" className="btn  btn-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit Bid">Edit</Link>
                                <Link href="#" className="btn  btn-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Retract Bid">Retract Bid</Link>
                              </td>
                            </tr>
                            <tr>
                              <td className="d-flex align-items-center">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-stack py-4">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="mb-0 me-2">
                        <Link href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">You got a project invitation from max Plank</Link>
                  ...
                  <div className="d-flex flex-stack py-4">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      {/* <!--begin::Title--> */}
                      <div className="mb-0 me-2">
                        <Link href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">You got a request for payment release from Steve messon</Link>
                  ...
                  <div className="d-flex flex-stack py-4">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      {/* <!--begin::Title--> */}
                      <div className="mb-0 me-2">
                        <Link href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">You got a material list from Ernest Ruby</Link>
                  ...
                  <div className="d-flex flex-stack py-4">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      {/* <!--begin::Title--> */}
                      <div className="mb-0 me-2">
                        <Link href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">You got a project invitation from Stephen Clerk</Link>
                        {/* <!-- <div className="text-gray-400 fs-7">Phase 1 development</div> --> */}
                      </div>
                      {/* <!--end::Title--> */}
                    </div>
                  ...
                  <div className="d-flex flex-stack py-4">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      {/* <!--begin::Title--> */}
                      <div className="mb-0 me-2">
                        <Link href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">You got a request for payment release from Tony wilbert</Link>
                        {/* <!-- <div className="text-gray-400 fs-7">New frontend admin theme</div> --> */}
                      </div>
                      {/* <!--end::Title--> */}
                    </div>
                      ...
                      <div className="px-7 py-5">
                        ...
                        <div className="mb-10">
                          ...
                          <div className="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                            <input className="form-check-input" type="checkbox"  name="notifications" checked="checked" />
                ...
                <div className="card-body pt-5">
                  ...
                  <div className="timeline">
                    ...
                    <div className="timeline-item">
                      ...
                      {/* <!--end::Avatar--> */}
                      {/* <!--begin::Text--> */}
                      <div className="fw-mormal timeline-content text-muted ps-3">Lrem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever...<Link className="text-primary" href="../projectdetails/">read more</Link></div>
                      {/* <!--end::Text--> */}
                    </div>
                    {/* <!--end::Item--> */}
                    {/* <!--begin::Item--> */}
          ...
          {/* <!-- <li className="nav-item p-0 ms-0">
                    <Link className="nav-link btn btn-color-gray-400 flex-center px-3 active" data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="#kt_timeline_widget_4_tab_day"> --> */}
          {/* <!--begin::Title--> */}
          ...
          {/* <!--begin::Nav item--> */}
          {/* <!-- <li className="nav-item p-0 ms-0">
                    <Link className="nav-link btn btn-color-gray-400 flex-center px-3" data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="#kt_timeline_widget_4_tab_week"> --> */}
          {/* <!--begin::Title--> */}
          ...
          {/* <!--begin::Nav item--> */}
          {/* <!-- <li className="nav-item p-0 ms-0">
                    <Link className="nav-link btn btn-color-gray-400 flex-center px-3" data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="#kt_timeline_widget_4_tab_month"> --> */}
          {/* <!--begin::Title--> */}
          ...
          {/* <!--begin::Nav item--> */}
          {/* <!-- <li className="nav-item p-0 ms-0">
                    <Link className="nav-link btn btn-color-gray-400 flex-center px-3" data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="#kt_timeline_widget_4_tab_2022"> --> */}
          {/* <!--begin::Title--> */}
