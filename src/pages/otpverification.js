...
export default function Otpverification() {
    ...
    const resendOTPApi = async () => {
        ...
        var response = await fetchDataPrivate('post',"api/resendOTP", data);
        if (response.status === 200) {
            // window.localStorage.setItem('token',response.data[0].token);
                                ...
                                <div className="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                                    ...
                                    <div className="form w-100 mb-13">
                                        ...
                                        <div className="text-center mb-10">
                                            ...
                                            {/* <!--end::Title--> */}
                                            {/* <!--begin::Sub-title--> */}
                                            <div className="text-muted fw-semibold fs-5 mb-5">Enter the verification code we sent to email</div>
                                            {/* <!--end::Sub-title--> */}
                                            {/* <!--begin::Mobile no--> */}
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <div className="d-flex flex-wrap flex-stack">
                                                <input type="text" name="code_1" maxLength="1" className="form-control bg-transparent h-60px w-60px fs-2qx text-center mx-1 my-2" value={code_1} onChange={(e) => {setCode_1(e.target.value);handleInputChange(e, setCode_1)}} onKeyPress={handleKeyPress}/>
                                                <input type="text" name="code_2" maxLength="1" className="form-control bg-transparent h-60px w-60px fs-2qx text-center mx-1 my-2" value={code_2} onChange={(e) => {setCode_2(e.target.value);handleInputChange(e, setCode_2)}} onKeyPress={handleKeyPress}/>
                                                <input type="text" name="code_3" maxLength="1" className="form-control bg-transparent h-60px w-60px fs-2qx text-center mx-1 my-2" value={code_3} onChange={(e) => {setCode_3(e.target.value);handleInputChange(e, setCode_3)}} onKeyPress={handleKeyPress}/>
                                                <input type="text" name="code_4" maxLength="1" className="form-control bg-transparent h-60px w-60px fs-2qx text-center mx-1 my-2" value={code_4} onChange={(e) => {setCode_4(e.target.value);handleInputChange(e, setCode_4)}} onKeyPress={handleKeyPress}/>
                                                <input type="text" name="code_5" maxLength="1" className="form-control bg-transparent h-60px w-60px fs-2qx text-center mx-1 my-2" value={code_5} onChange={(e) => {setCode_5(e.target.value);handleInputChange(e, setCode_5)}} onKeyPress={handleKeyPress}/>
                                                <input type="text" name="code_6" maxLength="1" className="form-control bg-transparent h-60px w-60px fs-2qx text-center mx-1 my-2" value={code_6} onChange={(e) => {setCode_6(e.target.value);handleInputChange(e, setCode_6)}} onKeyPress={handleKeyPress}/>
                                            </div>
                                            {/* <!--begin::Input group--> */}
                                        </div>
                                        {/* <!--end::Section--> */}
                                    ...
                                    <div className="text-center fw-semibold fs-5">
                                        ...
                                        {/* <Link to="/otpverification/" className="link-primary fs-5">Call Us</Link> */}
                                    </div>
                                    {/* <!--end::Notice--> */}
                                </div>
                                {/* <!--end::Wrapper--> */}
